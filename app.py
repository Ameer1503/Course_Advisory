...
from admin import StudentAdmin, LecturerAdmin, ConversationAdminView, MessageAdminView
from models import Student, Lecturer, Admin, Conversation, Message
from forms import StudentRegistrationForm, LecturerRegistrationForm, StudentLoginForm, LecturerLoginForm
...
admin.add_view(ConversationAdminView(Conversation, db.session))
...
def student_dashboard():
    ...
    conversations = Conversation.query.filter_by(student_id=student_id).all()
    return render_template('student_dashboard.html', conversations=conversations)

@app.route('/lecturer/dashboard')
def lecturer_dashboard():
    # Retrieve the lecturer's conversations and pass them to the template
    lecturer_id = session['lecturer_id']
    conversations = Conversation.query.filter_by(lecturer_id=lecturer_id).all()
    return render_template('lecturer_dashboard.html', conversations=conversations)
